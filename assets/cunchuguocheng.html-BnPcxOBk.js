import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,e as a,o as p}from"./app-BugT5USA.js";const r={};function i(t,n){return p(),e("div",null,n[0]||(n[0]=[a(`<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义"><span>定义</span></a></h2><p>把复杂的操作，封装一个过程。类似于函数。</p><h3 id="优点" tabindex="-1"><a class="header-anchor" href="#优点"><span>优点</span></a></h3><p>1、复杂操作，调用简单。<br> 2、速度快。</p><h3 id="缺点" tabindex="-1"><a class="header-anchor" href="#缺点"><span>缺点：</span></a></h3><p>1、封装复杂。<br> 2、没有灵活性。</p><h3 id="查看所有存储过程命令" tabindex="-1"><a class="header-anchor" href="#查看所有存储过程命令"><span>查看所有存储过程命令</span></a></h3><p>1 show procedure status;<br> 查看存储过程或函数的创建代码：<br> 1 show create procedure proc_name;<br> 2 show create function func_name;<br> 调用存储命令：<br> 1 call 名称;<br> 删除存储过程命令：<br> 1 DROP {PROCEDURE | FUNCTION} [IF EXISTS] 名称；<br> 创建存储过程：<br> 1 create procedure 名称(参数,.....)<br> 2             begin<br> 3                 过程体;<br> 4                 过程体;<br> 5             end//<br> 参数：<br> 1 in|out|inout 参数名称 类型(长度)<br> 在sql语句中给变量赋值：<br> 1 into<br> 在过程体外声明变量：<br> 1 @变量名<br> 重新制定sql语句的结束符：<br> 1 delimiter //<br> 例子：获取5条文章记录<br> 1 create procedure getNews()<br> 2     begin<br> 3         select * from news limit 5;<br> 4     end//<br> 例子：获取n条文章记录<br> 1 create procedure getNewsN(in n int(5))<br> 2     begin<br> 3         select * from news limit n;<br> 4     end//<br> 例子：获取某栏目下文章的条数。<br> 1 create procedure getNewsByType(in fid int,out num int)<br> 2     begin<br> 3         select count(*) into num from news where fcid=fid;<br> 4     end//<br> 声明变量：<br> 1 declare 变量名 类型(长度) default 默认值;<br> 给变量赋值：<br> 1 set 变量名=值;<br> 说明：<br> 强类型。<br> 例子：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>1 create procedure test()</span></span>
...
<span class="line"><span>8     end//</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>1.3 条件语句</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span> 1 if 条件 then</span></span>
...
<span class="line"><span>10     end//</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>例子：使用存储过程实现 购物</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span> 1 create procedure buy1(in pidn int,in uidn int,in numn int)</span></span>
<span class="line"><span> 2 begin</span></span>
