...
在项目的 `AGENTS.md` 或 `CLAUDE.md` 中添加编码规范，约束开发环境行为，从源头规避乱码问题：
...
| 配置编码规范 | 团队统一，无需改环境 | 需团队成员使用 AI Agent 工具；需维护 AGENTS.md 文件；对不使用 AI 工具的成员无约束力；每次 AI 会话会消耗额外 token 读取规范 |
